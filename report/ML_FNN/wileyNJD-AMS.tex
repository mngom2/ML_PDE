...
\title{Approximating periodic functions and solving differential equations using a novel type of Fourier Neural Networks\protect\thanks{This material was based upon work funded by the U.S. Department of Energy, Office of Science, under contract DE-AC02-06CH11357}}
...
\end{table}
 \begin{figure}[!htb]
    \centering
    \subfigure{\includegraphics[width=0.6\textwidth]{fnnl2vsexactcomp.eps}}
     \subfigure{\includegraphics[width=0.6\textwidth]{fnnl1vsexactcomp.eps}}
...
%\textcolor{red}{PUT figure of architecture here.}\\ 
