...
BATCHSIZE = 101*101
n_nodes = 10
HIDDEN_UNITS = [n_nodes, n_nodes, n_nodes, n_nodes]

restore_name = 'test_model/4_layer_sq_loss_101_m_iter_50000_rs_42'
...
with tf.Session() as sess:
	...
	err, nn,xx = draw_magnitude_of_err_2d(problem.range, problem.range, problem.fun, 1001, 1, neural_network.value)
	print(err)
