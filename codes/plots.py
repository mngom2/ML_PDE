...
restore_name = 'test_model/1_layer_sq_loss_100_m_iter_50000_rs_42_nodes_4'
...
with tf.Session() as sess:
	...
	err, nn,xx = draw_magnitude_of_err_2d(problem.range, problem.range, problem.fun, 101, 1, neural_network.value)
	print(err)
	
    


	np.savetxt("nn_coef_tanh_x2_out.txt", nn, fmt="%s")
